...
def api_generate_cert(ero_id: str, token: str = Depends(bearer_auth)):
    logger.info(f"AUDIT: IRS certificate generated for ERO {ero_id}")
...
def api_get_cert(ero_id: str, token: str = Depends(bearer_auth)):
    logger.info(f"AUDIT: IRS certificate retrieved for ERO {ero_id}")
