...
import PreSubmissionCheck from './PreSubmissionCheck.tsx';
...
// Vite provides import.meta.env, but fallback for CommonJS builds
const API_BASE = (typeof import.meta !== 'undefined' && import.meta.env && import.meta.env.VITE_API_BASE) ? import.meta.env.VITE_API_BASE : (process.env.VITE_API_BASE || '');
      ...
      <div className="max-w-5xl mx-auto px-4 py-10 space-y-6">
        <header className="space-y-1">
          ...
          <p className="text-slate-300">
            Secure professional tax platform with IRS MeF integration.
          </p>
        </header>
